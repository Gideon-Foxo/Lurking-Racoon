...
module.exports = {
    ...
    name: 'ban',
    aliases: ['b', 'bean', 'ak47'],
    description: `This command bans a user server the server. This does not delete any messages.\n**Usage:** \`${config.prefix}ban @Gideon  💙🧡#4325 Being a bad foxo\``,
    ...
    try {
        try { 
          ...
          await  print(error)
            await message.channel.send('<:error:658018643329679370> I was not able to send this user a DM.')
        }
        
           await message.guild.ban(bUser, {reason: bReason})
           const embed = new Discord.RichEmbed()
